 ...
 ******************************************************************************
 */
#ifndef xendroid_XE_OPENSLES_AUDIO_SYSTEM_H
#define xendroid_XE_OPENSLES_AUDIO_SYSTEM_H
...
namespace xe {
    namespace apu {
        namespace opensles {
            ...
            class OpenSLESAudioSystem : public AudioSystem {
            public:
                explicit OpenSLESAudioSystem(cpu::Processor *processor);
...
#endif //xendroid_XE_OPENSLES_AUDIO_SYSTEM_H
