...
class SettingsModifiedTest {
    ...
    @Test fun both_null_fall_to_schema_default_not_modified() {
        assertFalse(modified(effectiveLive = null, effectiveTemplate = null, schemaDefault = "false"))
    }

    @Test fun live_true_template_false_is_modified() {
        assertTrue(modified(effectiveLive = "true", effectiveTemplate = "false", schemaDefault = "false"))
    }
    ...
    @Test fun live_null_template_matches_schema_default_not_modified() {
        ...
        assertFalse(modified(effectiveLive = null, effectiveTemplate = "false", schemaDefault = "false"))
    }

    @Test fun live_differs_from_template_via_null_fallback_is_modified() {
        // live null -> schema default "false"; template "true" -> modified.
        assertTrue(modified(effectiveLive = null, effectiveTemplate = "true", schemaDefault = "false"))
    }
}
