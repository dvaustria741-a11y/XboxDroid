...
import aenu.ax360e.compose.settings.Setting.*

private fun b(s: String, n: String, t: String, d: Boolean) = Bool(s, n, t, d)
private fun i(s: String, n: String, t: String, d: Int, lo: Int, hi: Int) = IntRange(s, n, t, d, lo, hi)
private fun l(s: String, n: String, t: String, d: String, vararg o: Pair<String, String>) =
    ListChoice(s, n, t, d, o.map { ListOption(it.first, it.second) })
